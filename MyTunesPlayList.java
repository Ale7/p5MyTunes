...
public class MyTunesPlayList extends PlayList {
	 ...
	 * 
	 * @param file
	 *        the file to load the song data from.
	 */
	...
	/**
	 * Stops the song that is currently playing (if any) and plays the given
	 * song if it exists in the playlist. Does nothing if the song is not in the
	 * list.
	 * 
	 * @param song 
	 *        the song to play.
	...
	/**
	 * Stops the song that is currently playing (if any) and plays the song at
	 * the given index. Does nothing if the index is invalid.
	 * 
	 * @param index
	...
	/**
	 * Stops the song that is currently playing (if any) and plays the next song
	 * in the list. If the song is the last song in the list, then it will wrap
	 * around and start playing at song 0.
	 */
	...
	/**
	 * Stops the song that is currently playing (if any) and plays the previous
	 * song in the list. If the song is the first song in the list, then it will
	 * wrap around and start playing the last song.
	 */
	 ...
	 * 
	 * @return the song that is currently playing, or null if no song is
	 *         playing.
	 */
	 ...
	 * 
	 * @return the index of the song that is playing, or -1 if no song is
	 *         playing.
	 */
	...
	/**
	 * Sets whether the playlist will continue to play all songs in order or
	 * not. If set to true, the next song should play after the previous
	 * finishes.
	 * 
	 * @param flag
	 *        - specify true to turn on, false to turn off.
	 */
	...
	/**
	 * Returns whether the playlist will continue to play all songs in order or
	 * not.
	 * 
