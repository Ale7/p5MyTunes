...
public class PlayableSong {
	 ...
	 *
	 * @param filePath
	 *        The file path fo the clip that will be played.
	 */
	...
	/**
	 * Returns the number of times the song has been played. The count is
	 * incremented every time the play method is called.
	 *
